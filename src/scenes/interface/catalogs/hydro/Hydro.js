...
export default class Hydro extends News {
    ...
    preload() {
        ...
        this.load.pack("hydro-pack", "assets/media/interface/catalogs/hydro-pack.json");
    }
    ...
    _create() {
        ...
        bodytext.setStyle({ "color": "#ffffffff", "fontFamily": "Burbank Small", "fontSize": "20px", "shadow.offsetX":1,"shadow.offsetY":1,"shadow.color": "#042635ff", "shadow.blur":3,"shadow.fill":true});
        ...
        txt_rodheader_1.setStyle({ "align": "center", "color": "#000000ff", "fontFamily": "Burbank Small", "fontSize": "21px", "fontStyle": "bold", "shadow.color": "#042635ff" });
        ...
        txt_rodheader_1_1.setStyle({ "align": "center", "color": "#000000ff", "fontFamily": "Burbank Small", "fontSize": "21px", "fontStyle": "bold", "shadow.color": "#042635ff" });
