...
export default class Dance extends RoomScene {
    ...
    _create() {
        ...
        // floorbg
        const floorbg = this.add.sprite(632, 695, "fof-dance", "floorbg0001");

        // floordayanim
        const floordayanim = this.add.sprite(589, 807, "fof-dance", "floordayanim0001");

        // floorframe
        this.add.image(632, 692, "fof-dance", "floorframe");

        // bg
        this.add.image(760, 480, "fof-dance", "fofbg");

        // wire
        const wire = this.add.image(1284, 725, "dance", "wire");
        wire.setOrigin(0.5, 0.5070422535211268);

        // stage
        const stage = this.add.image(651, 384, "dance", "stage");
        ...
        // speaker_3
        const speaker_3 = this.add.image(119, 827, "fof-dance", "bottomspeakerclouds0001");
        speaker_3.setOrigin(0.5297297297297298, 0.8456140350877193);

        // speakerclouds0001
        this.add.image(664, -13, "fof-dance", "speakerclouds0001");
        ...
        // lists
        const sort = [speaker_3, boiler, box, dj_speaker, mixer, puffle_speaker];
        ...
        this.floorbg = floorbg;
        this.floordayanim = floordayanim;
        this.puffle = puffle;
    ...
    create() {
        ...
        this.floordayanim.play('floordayanim')
        this.floorbg.play('floorbg')
