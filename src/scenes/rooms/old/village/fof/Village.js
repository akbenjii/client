...
export default class Village extends RoomScene {
    ...
    _create() {
        ...
        // lights
        this.add.image(798, 186, "fof-village", "lights");
        ...
        // post
        this.add.image(342, 341, "fof-village", "post");

        // signs
        this.add.image(835, 153, "fof-village", "signs");

        // balloons
        this.add.image(917, 382, "fof-village", "balloons");

        // propvillage
        const propvillage = this.add.sprite(94, 661, "fof-village", "propvillage0001");
        propvillage.scaleX = 0.35;
        propvillage.scaleY = 0.35;

        // propholdvillage
        const propholdvillage = this.add.image(98, 755, "fof-village", "propholdvillage");
        propholdvillage.scaleX = 0.35;
        propholdvillage.scaleY = 0.35;

        // propvillage_1
        const propvillage_1 = this.add.sprite(261, 557, "fof-village", "propvillage0001");
        propvillage_1.scaleX = 0.3;
        propvillage_1.scaleY = 0.3;

        // propholdvillage_1
        const propholdvillage_1 = this.add.image(264, 636, "fof-village", "propholdvillage");
        propholdvillage_1.scaleX = 0.3;
        propholdvillage_1.scaleY = 0.3;
        ...
        this.propvillage = propvillage;
        this.propvillage_1 = propvillage_1;
        this.sort = sort;
    ...
    create() {
        super.create()
        this.propvillage.play('propvillage')
		this.propvillage_1.play('propvillage')
    }
    /* END-USER-CODE */
}
