...
export default class Town extends RoomScene {
    ...
    _preload() {
        ...
        this.load.pack("pgtown-pack", "assets/media/rooms/old/town/pg/pgtown-pack.json");
    ...
    _create() {
        ...
        // bg
        const bg = this.add.image(-23, 0, "pg-town", "bg");
        bg.setOrigin(0, 0);

        // bottom_rope
        const bottom_rope = this.add.image(585.5770853822211, 1010.7910862769722, "pg-town", "bottom_rope");
        bottom_rope.setOrigin(0.5039254591614246, 1.2363904227658158);

        // left_rope
        const left_rope = this.add.image(337, 795.3347748754987, "pg-town", "left_rope");
        left_rope.setOrigin(0.5, 0.999534577114081);

        // right_rope
        const right_rope = this.add.image(1211, 796, "pg-town", "right_rope");
        right_rope.setOrigin(0.5096745649141026, 0.9940496841828053);

        // fg
        const fg = this.add.image(-67.94154189688778, 1151.4247373395162, "town", "fg");
        fg.setOrigin(-0.002866323606083402, 1.3127000665588524);
        ...
        // mountain_flame
        const mountain_flame = this.add.sprite(71, 290, "pg-town", "mountain_flame0001");
        mountain_flame.scaleX = 0.16106360800746933;
        mountain_flame.scaleY = 0.16106360800746933;
        mountain_flame.setOrigin(0.5063553615092872, 0.5649311318732098);

        // fire_holder
        this.add.image(71, 305, "pg-town", "fire_holder");

        // lists
        const sort = [fg, box_2, box_1, box_3, chair_2, chair_1, table_1, table_2, canopy, canopy_stars, canopy_lights, left_rope, right_rope, bottom_rope];
        ...
        this.disco = disco;
        this.mountain_flame = mountain_flame;
        this.sort = sort;
    ...
    create() {
        super.create()
        this.mountain_flame.play('mountain_flame')
    }
