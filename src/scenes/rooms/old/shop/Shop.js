...
export default class Shop extends RoomScene {
    ...
    _preload() {
        ...
        this.load.pack("shop-pack", "assets/media/rooms/old/shop/shop-pack.json");
    }
    ...
    _create() {
        ...
        // bg_2005_shop
        const bg_2005_shop = this.add.image(-7, -3, "bg_2005_shop");
        ...
        // tube2
        this.add.image(175, 756, "tube2");

        // tube1
        this.add.image(175, 810, "tube1");
