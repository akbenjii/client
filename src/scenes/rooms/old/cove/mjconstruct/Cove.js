...
export default class Cove extends RoomScene {
    ...
    _create() {
        ...
        // shadows
        this.add.image(840, 486, "mjc-cove", "shadows");

        // right_box
        const right_box = this.add.image(926, 412, "mjc-cove", "right_box");
        right_box.scaleX = 0.6425939087230266;
        right_box.scaleY = 0.6425939087230266;

        // left_box
        const left_box = this.add.image(770, 453, "mjc-cove", "left_box");
        left_box.scaleX = 0.6425939087230266;
        left_box.scaleY = 0.6425939087230266;
