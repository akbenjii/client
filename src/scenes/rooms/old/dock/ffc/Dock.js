...
export default class Dock extends RoomScene {
    ...
    _create() {
        ...
        // shadows
        this.add.image(776, 496, "ffc-dock", "shadows");

        // table
        const table = this.add.image(1083, 554, "ffc-dock", "table");

        // box_1
        const box_1 = this.add.image(1062, 315, "ffc-dock", "box");
        box_1.scaleX = 1.2037378921234847;
        box_1.scaleY = 1.2037378921234847;
        box_1.flipX = true;

        // box_coffee
        const box_coffee = this.add.image(873, 348, "ffc-dock", "box_coffee");

        // wood
        this.add.image(485, 359, "ffc-dock", "wood");

        // lists
        const sort = [post_3, post_4, post_1, post_2, rings, bollard_2, bollard_1, dock, box, table, box_coffee, box_1];
