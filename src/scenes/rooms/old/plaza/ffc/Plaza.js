...
export default class Plaza extends RoomScene {
    ...
    _create() {
        ...
        // shadows
        this.add.image(798, 756, "ffc-plaza", "shadows");
        ...
        // back_scaffold
        this.add.image(1046, 430, "ffc-plaza", "back_scaffold");

        // scaffold
        const scaffold = this.add.image(912.1707157995011, 489.7649757164029, "ffc-plaza", "scaffold");
        ...
        coffee.setOrigin(0.5, 0.5864761812716934);

        // table
        const table = this.add.image(1200, 711.0441913230043, "ffc-plaza", "table");
        table.setOrigin(0.5, 0.44397317833101596);

        // warning
        const warning = this.add.image(777, 619.4419090176015, "ffc-plaza", "warning");
        warning.setOrigin(0.5, 0.8624036787809698);

        // lists
        const sort = [lamp, tickets, scaffold, coffee, box, table, warning];
