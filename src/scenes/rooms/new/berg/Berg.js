...
export default class Berg extends RoomScene {
    ...
    editorPreload() {
        ...
        this.load.pack("berg-pack-new", "assets/media/rooms/new/berg/berg-pack-new.json");
    }
    ...
    _create() {
        ...
        // bg
        const bg = this.add.image(-18, -18, "berg-new", "bg");
        bg.setOrigin(0, 0);

        // aqua
        const aqua = this.add.sprite(1255, 325, "berg-new", "aqua0001");
